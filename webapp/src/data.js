...
// Web deployment serves the repo root, so the app at /webapp/ reaches the data
// one level up. The iOS bundle has a flat layout instead and overrides this via
// window.GAMEDATA_BASE (set by scripts/build-ios-www.mjs).
const BASE = window.GAMEDATA_BASE || "../shared/gamedata/";
